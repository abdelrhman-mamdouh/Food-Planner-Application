package com.example.foodzarella.ui.mealPlan;

import static com.example.foodzarella.ui.mealPlan.CalendarUtils.daysInWeekArray;
import static com.example.foodzarella.ui.mealPlan.CalendarUtils.monthYearFromDate;
...
import com.example.foodzarella.ui.favorites.FavoritesFragment;
        ...
        query.get().addOnCompleteListener(task -> {
            if (task.isSuccessful()) {
                ...
                if (querySnapshot.isEmpty()) {
                    // Handle case when no dayMeals are found
